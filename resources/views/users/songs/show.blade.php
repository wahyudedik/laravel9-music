                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    @php
                                                        $licenceAmountLocal = $licence->amount_type == 'Price' ? 'Rp.' . number_format($licence->local_amount) : number_format($licence->local_amount) . '%';
                                                        $licenceAmountGlobal = $licence->amount_type == 'Price' ? 'Rp.' . number_format($licence->global_amount) : number_format($licence->global_amount) . '%';
                                                    @endphp
                                ...
                                <tbody>
                                    @forelse ($song->coverVersions as $cover)
                                        @php
                                            ...
                                            $avatarUrl = 'https://ui-avatars.com/api/?name=' . urlencode($name) . '&background=e53935&color=fff';
                                        @endphp
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
