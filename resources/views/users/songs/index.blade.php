            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="{{ route('user.songs.create') }}" class="btn btn-primary d-sm-none btn-icon">
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card mb-4 " style="overflow: auto;">
                ...
                <form id="form-filter" action="{{ route('user.songs.index') }}" method="GET" class="d-flex">
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('user.songs.index') }}" id="reset-filters"
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex">
                        <form action="{{ route('user.songs.index') }}" method="GET" class="d-flex">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="{{ route('user.songs.edit', $song->id) }}"
                                                    class="dropdown-item">
                                                ...
                                                <form id="delete-form-{{ $song->id }}"
                                                    action="{{ route('user.songs.destroy', $song) }}" method="POST"
                                                    class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                ...
                btn.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            fetch(`{{ route('user.songs.bulk-action') }}`, {
                                    method: 'POST',
                                    headers: {
