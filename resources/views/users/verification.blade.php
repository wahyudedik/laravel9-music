                    ...
                    <div class="card-body">
                        <form action="{{ route('verification.submit') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <p id="type_display">Pembuat cover</p>
                                <small class="form-text text-muted" style="font-style: italic; color: red;">* Verifikasi
                                    Pertama</small>
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <input type="file" name="document_npwp" id="document_npwp" class="form-control"
