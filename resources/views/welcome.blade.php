        ...
        <div class="scroll-container">
            ...
            @foreach ($songs as $song)
                @php
                    ...
                    $imageUrl = $filename ? route('user.songs.image', ['filename' => $filename]) : 'https://via.placeholder.com/500/500?random=' . $song->id;
                @endphp
                @php
                    $creatorName =
                ...
                <div class="scroll-item music-card-item" data-aos="fade-up" data-aos-delay="{{ 1 * 50 }}">
                    <div class="relative group overflow-hidden rounded-xl">
                        ...
                        <button class="play-song-btn absolute inset-0 flex items-center justify-center"
                            ...
                            data-title="{{ $song->title }}" data-artist="{{ $artistName }}"
                            data-cover="{{ $imageUrl }}" data-id="{{ $song->id }}"
                            data-duration="{{ rand(180, 320) }}">
                            <div
