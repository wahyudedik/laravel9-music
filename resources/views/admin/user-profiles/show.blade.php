                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mt-3">
                                    ...
                                    <div class="tab-content">
                                                    ...
                                                    <tbody>
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            <tr>
                                                                ...
                                                                <td>{{ rand(2, 5) }}:{{ sprintf('%02d', rand(0, 59)) }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            ...
                                                                            <a href="#" class="dropdown-item">
                                                                                <i
                                                                                    class="ti ti-player-play me-2"></i>Preview
                                                                            </a>
                                                                            {{-- @if ($i % 3 != 1)
                                                                                <a href="#"
                                        ...
                                        <div class="tab-pane" id="published">
                                            <div class="d-flex justify-content-between mb-3">
                                                ...
                                                <div class="btn-group">
                                                    <button type="button"
                                                        class="btn btn-outline-primary active">All</button>
                                        ...
                                        <div class="tab-pane" id="activity">
                                            <div class="d-flex justify-content-between mb-3">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-primary">Content</button>
                                                    <button type="button"
                        ...
                        <div class="modal modal-blur fade" id="editUserModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select">
                                                        {{-- <option value="user" {{ $id % 4 == 3 ? 'selected' : '' }}>
                                                            Regular User
                                                        </option>
                                                        <option value="artist" {{ $id % 4 == 0 ? 'selected' : '' }}>Artist
                                                        </option>
                                                        <option value="composer" {{ $id % 4 == 1 ? 'selected' : '' }}>
                                                            Composer
                                                        </option>
                                                        <option value="cover_creator"
                                                            {{ $id % 4 == 2 ? 'selected' : '' }}>Cover
                                                            Creator</option> --}}
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select">
                                                        ...
                                                        <option value="suspended" {{ $id % 5 == 0 ? 'selected' : '' }}>
                                                            Suspended
                                                        </option> --}}
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select">
                                                        {{-- <option value="verified" {{ $id % 3 != 0 ? 'selected' : '' }}>
                                                            Verified
                                                        </option>
                                                        <option value="pending" {{ $id % 3 == 0 ? 'selected' : '' }}>
                                                            Pending
                                                            Verification</option>
                                ...
                                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div>You are about to suspend this user account. The user will not be able to
                                                log in
                                                or use
                            ...
                            <!-- Add Song Modal -->
                            <div class="modal modal-blur fade" id="addSongModal" tabindex="-1" role="dialog"
                                aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <!-- Edit Song Modal -->
                            <div class="modal modal-blur fade" id="editSongModal" tabindex="-1" role="dialog"
                                aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
